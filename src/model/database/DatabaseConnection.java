...
public class DatabaseConnection {
	...
	static {
		try {
			...
			LOG.warn(String.format(Constants.ERROR_TO_CHARGE_CLASS_FOR_NAME, CLASS_FOR_NAME, e.getMessage()));
		}
	}
	...
	public static Connection getConnection() {
		try {
			...
			LOG.warn(String.format(Constants.DATABASE_CONNECTION_ERROR, e.getMessage()));
			return null;
		}
	}
